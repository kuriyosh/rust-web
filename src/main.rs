...
// TodoRepositoryForMemory でも良いが、後で DB 用のものに置き換えるので generics にしておく
fn create_app<T: TodoRepository>(repository: T) -> Router {
    Router::new()
        ...
        // 以下のように記述することによって、repository を共有して使える
...
mod test {
    ...
    async fn should_get_all_todos() {
        ...
        let todo: Vec<Todo> = serde_json::from_str(&body)
            .expect(&format!("cannot ocnvert Todo instance. body: {}", body));
